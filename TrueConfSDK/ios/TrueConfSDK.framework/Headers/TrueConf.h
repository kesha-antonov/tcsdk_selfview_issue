...
@property (nonatomic) BOOL hideSelfViewButtonsInSmallSize;
@property (nonatomic) BOOL muteAudio; // NO by default
@property (nonatomic) BOOL muteButtonVisible; // YES by default
@property (nonatomic) BOOL trueConfSDKLogEnable; // NO by default

- (instancetype _Nullable )initWithViewController:(UIViewController* _Nullable) vc forServer:(NSString* _Nullable) serverIP confCustomControlsImages:(NSDictionary* _Nullable) aCustomConfControlsImages;
- (instancetype _Nullable )initWithViewController:(UIViewController* _Nullable) vc forServer:(NSString* _Nullable) serverIP confCustomControlsImages:(NSDictionary* _Nullable) aCustomConfControlsImages directConnection:(BOOL) aDirectConnection;
- (void)setInitViewController:(UIViewController* _Nullable (^_Nullable) (void)) aInitViewController;
- (void)setNewExtraButtons:(NSArray<TCSDKExtraButton *> * _Nullable) btns;
